...
import '../models/info_mahasiswa_models.dart';

class info_mahasiswa_fom extends StatefulWidget {
  final Mahasiswa? initialData;

  const info_mahasiswa_form({super.key, this.initialData});

  @override
  State<info_mahasiswa_form> createState() => _info_mahasiswa_formState();
}

class _info_mahasiswa_formState extends State<info_mahasiswa_form> {
